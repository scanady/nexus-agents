...
This is the operator wrapper around the repo's research stack. It is not a replacement for `deep-research`, `exa-search`, or `strategy-market-researcher`; it tells you when and how to use them together.
...
- `strategy-market-researcher` when the end result should be a recommendation or ranked decision
...
- use `strategy-market-researcher` when the outcome should end in a recommendation
