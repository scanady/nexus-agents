...
**Evidence**
- [path/to/file.ext:line] [Where this was observed]
...
**Evidence**
- [path/to/file.ext:line] [Where error handling behavior is defined]
...
| Observation ID | Code Location | Note |
|----------------|---------------|------|
| OBS-XXX-001 | `path/to/file.ext:line` | Why it matters |
| OBS-XXX-002 | `path/to/file.ext:line` | Why it matters |
