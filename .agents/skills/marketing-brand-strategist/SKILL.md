...
- `./references/naming-methodology.md` for the six naming strategies, evaluation criteria, and anti-patterns
- `./references/presentation-workflow.md` for how to present, iterate, and help the user decide

These files contain hard-won best practices. Follow them.
...
1. **What does it do?** Get a plain-language description.
2. **Who is it for?** Understand the audience.
3. **What makes it different?** Find the angle.
4. **What's the scope today vs. tomorrow?** Names need room to grow.
5. **Any existing brand equity to preserve?** Previous names, logos, domains.
6. **TLD preference?** Default to .com, but ask.
7. **Vibes and aesthetics?** Brands they admire, words that resonate, feelings they want to evoke.
...
1. Metaphor and Analogy (strongest brands)
2. Domain-Specific Language (insider credibility)
3. Borrowed Words (fresh, distinctive)
4. Portmanteau / Fusion (two concepts, one word)
5. Modified Spelling (ownable twist on real words)
6. Abstract / Invented Words (hardest, most available)
...
- Sound and rhythm (say every name out loud in your head)
- Visual balance (how it looks written)
- The Phone Test (can someone spell it after hearing it once?)
- The Growth Test (will it still fit in 3 years?)
...
- Only present standard-price available domains — never include premium or unavailable domains
- Skip any domain that shows a premium price, aftermarket listing, or is already registered
- For promising names, check across the user's preferred TLDs

**Present 5-8 names per round.** Group by strategy or theme. For each name, provide:
- The available domain with a registration link
- Pronunciation guide (if not obvious)
- One sentence on what makes it work

### Step 4: Read and Iterate

After the user reacts, pay close attention:
- Which names did they gravitate toward? Why?
- Which did they reject? What specifically didn't work?
- Are there unstated preferences emerging?
...
### Step 5: Narrow and Decide

When the user has 2-3 finalists:
- Present a side-by-side comparison on the evaluation criteria
- Flag practical considerations (social handles, email, logo potential)
- Recommend the Sleep Test (sit with it for 24-48 hours)
- Remind about trademark searching (without giving legal advice)
- Emphasize registration urgency for chosen names
...
### "I need a name for my new company/product"
Full discovery flow. Don't skip steps.

### "Help me find a domain for [existing name]"
...
### "I have a name but want to rebrand"
...
### "These names aren't good enough"
