...
- [marketing-lead-magnet-generator](#marketing)
- [marketing-linkedin-writer](#marketing)
- [marketing-outreach-specialist](#marketing)
...
- [tech-test-driven-development](#technology)
- [tech-writing-plans](#technology)
...
- [forge-brand-strategist](#strategy)
- [mckinsey-problem-solving-brief](#strategy)
- [nudge-unit](#strategy)
- [startup-strategic-planning](#strategy)

### [monetization](#monetization)

- [adsense-readiness](#monetization)
- [adsense-review](#monetization)
...
| marketing-ideas | Produces the best marketing ideas by matching business context against a database of 170+ proven strategies. | active |
| marketing-lead-magnet-generator | Creates viral lead magnet posts that drive comments and DMs in quick and detailed formats. | active |
| marketing-linkedin-writer | Creates viral LinkedIn posts using proven formats, post templates, and voice matching. | active |
| marketing-outreach-specialist | Crafts high-converting outreach messages and email sequences for cold outreach and LinkedIn DMs. | active |
...
| tech-test-driven-development | Enforces test-first development by writing tests before implementation code on any feature or bugfix. | active |
| tech-writing-plans | Creates structured implementation plans from specs or requirements before touching code. | active |
...
| name | description | status |
| --- | --- | --- |
| brainstorming | Explores user intent, requirements, and design space before implementation on any creative or technical task. | active |
| customer-segmentation | Builds data-driven customer segment personas using hybrid qualitative and quantitative analysis methods. | active |
| forge-brand-strategist | Expert brand naming and domain strategy for businesses, products, apps, and ventures. | active |
| mckinsey-problem-solving-brief | Builds executive-ready strategic briefs using SCQ, MECE issue trees, and pyramid-structured recommendations. | active |
| nudge-unit | Applies nudge theory and choice architecture to design System 1 and System 2 behavioral interventions. | active |
| startup-strategic-planning | Delivers the 3 highest-impact next moves for growth by analyzing the founder's business context and bottlenecks. | active |

## monetization

| name | description | status |
| --- | --- | --- |
| adsense-readiness | Analyzes websites for Google AdSense policy compliance before applying for monetization. | active |
| adsense-review | Performs a comprehensive live-site review mimicking the Google AdSense approval process. | active |
